...
The 0–540 Ma elevation controls derive from Scotese & Wright (2018) PALEOMAP
PaleoDEM v2, CC BY 4.0. The runtime files sample the deposited 1 degree CSV
...
The present-day snapshot alone loads the Beck et al. (2023) historical
Köppen–Geiger classification for 1991–2020. The source Figshare dataset is CC0.
